    ...
    <div className='my-10'>
      <div className='text-center py-8 text-3xl'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Discover the latest products across Electronics, Home & Kitchen, Fashion, Beauty, Books, Sports, and more. Fresh arrivals added daily from top brands worldwide.
        </p>
      </div>
      {/* Rendering products */}
